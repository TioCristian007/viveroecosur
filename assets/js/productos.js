...
const PRODUCTOS = [
  ...
  { nombre:'Cerezo Reiner',         cat:'cerezas',    img:I+'cereza-reiner.jpg',
    desc:'Variedad de excelente calibre y sabor dulce equilibrado. Muy productiva en el clima del sur de Chile.' },
  { nombre:'Cerezo Corazón de Paloma', cat:'cerezas', img:I+'cereza-corazon-paloma.jpg',
  ...
  { nombre:'Guindo Ácido Rojo',     cat:'cerezas',    img:I+'guinda-acida.jpg',
  ...
  // ── 2. Manzanos, Perales y Membrillos ─────────────────────
  { nombre:'Manzano Cabeza de Niño', cat:'manzanos', img:I+'manzana-cabeza-nino.jpg',
  ...
  { nombre:'Manzano del Paraíso',   cat:'manzanos',   img:I+'manzana-paraiso.jpg',
    desc:'Variedad de manzano que da una manzanita pequeña, ideal para hacer conservas. Su floración es de color rosado.' },
  { nombre:'Manzano Fierro',        cat:'manzanos',   img:I+'manzana-fierro.jpg',
  ...
  { nombre:'Manzano Gravenstein',   cat:'manzanos',   img:I+'manzana-gravenstein.jpg',
  ...
  { nombre:'Manzano Limona',        cat:'manzanos',   img:I+'manzana-limona.jpg',
  ...
  { nombre:'Manzano Plátano',       cat:'manzanos',   img:I+'manzana-platano.jpg',
  ...
  { nombre:'Manzano Reineta',       cat:'manzanos',   img:I+'manzana-reineta.jpg',
  ...
  { nombre:'Peral Bartlett',        cat:'manzanos',   img:I+'pera-bartlett.jpg',
    desc:'Variedad clásica de pera, fruto grande y aromático de piel amarilla. Excelente para consumo fresco, conservas y jugos. Muy productivo.' },
  ...
  { nombre:'Ciruelo Angelina',      cat:'ciruelas',   img:I+'ciruela-angelina.jpg',
  ...
  { nombre:"Ciruelo D'Agen",        cat:'ciruelas',   img:I+'ciruela-dagen.jpg',
  ...
  { nombre:'Duraznero Beterraga',   cat:'ciruelas',   img:I+'durazno-beterraga.jpg',
  ...
  { nombre:'Duraznero Carson',      cat:'ciruelas',   img:I+'durazno-carson.jpg',
  ...
  { nombre:'Duraznero Plátano',     cat:'ciruelas',   img:I+'durazno-platano.jpg',
  ...
  // ── 4. Frutales Menores ───────────────────────────────────
  { nombre:'Arándano',              cat:'berries',    img:I+'arandanos.jpg',
  ...
  { nombre:'Frambueso',             cat:'berries',    img:I+'frambuesas.jpg',
  ...
  { nombre:'Frutilla',              cat:'berries',    img:I+'frutillas.jpg',
  ...
  { nombre:'Grosella',              cat:'berries',    img:I+'grosellas.jpg',
  ...
  // ── 8. Cítricos ───────────────────────────────────────────
  { nombre:'Limonero',              cat:'citricos',   img:I+'limones.jpg',
  ...
  { nombre:'Limonero Variegado',    cat:'citricos',   img:I+'limon-variegado.jpg',
  ...
  { nombre:'Naranjo',               cat:'citricos',   img:I+'naranjo.jpg',
    desc:'Cítrico clásico de frutos dulces y aromáticos. Requiere protección de heladas en el sur. Árbol ornamental y productivo, ideal para patios soleados.' },
  ...
  // ── 9. Ornamentales ───────────────────────────────────────
  { nombre:'Azalea',                cat:'ornamentales', img:I+'azalea.jpg',
  ...
  { nombre:'Rododendro',            cat:'ornamentales', img:I+'rododendro.jpg',
  ...
  { nombre:'Camelia',               cat:'ornamentales', img:I+'camelia.jpg',
  ...
  { nombre:'Erika',                 cat:'ornamentales', img:I+'erika.jpg',
  ...
  { nombre:'Lavanda',               cat:'ornamentales', img:I+'lavanda.jpg',
  ...
  { nombre:'Helecho Paragua',       cat:'ornamentales', img:I+'helecho-paragua.jpg',
  ...
  // ── 11. Otras Especies ────────────────────────────────────
  { nombre:'Higuera',               cat:'otras',      img:I+'higuera.jpg',
  ...
  { nombre:'Parra',                 cat:'otras',      img:I+'parra.jpg',
